...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text("Invite space member"),
//         centerTitle: true,
//       ),
//       body: Padding(
...
//             onPressed: () async {
//               List<Member?>? members = await UserRepo().readAllWhere([
...
//
//                 UserEntity? newMember = members.first;
//                 if (widget.member.teamId == null) {
//                   newMember = newMember.copyWith(teamId: teamId);
//                   await UserRepo().updateSingle(widget.member.id, newMember);
//                   await UserRepo().updateSingle(newMember!.id, newMember);
//                   space newTeam = space(
//                     id: teamId,
...
//                     newTeam,
//                     itemId: widget.member.teamId!,
//                   );
//                 } else {
//                   newMember?.teamId = widget.member.teamId;
//                   await UserRepo().updateSingle(newMember!.id, newMember);
//                   widget.space?.membersIds?.add(newMember.id);
//                   await TeamRepo().updateSingle(
