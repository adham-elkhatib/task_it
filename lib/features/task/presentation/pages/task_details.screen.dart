...
class _TaskDetailsScreenState extends State<TaskDetailsScreen> {
  ...
  updateTask() async {
    ...
    for (ActionItem createdActionItem in createdActionItems) {
      if (createdActionItem.title.trim() != "") {
        ...
        await ActionItemsRepo().createSingle(
          createdActionItem,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(widget.task.title), centerTitle: true),
      body: Padding(
          ...
          child: Column(
            ...
            children: [
                          ...
                          items: const [
                            DropdownMenuItem(
                              ...
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  StatusContainer(status: TaskStatus.toDo),
                                  SizedBox(width: 8),
                                  Text(
                                    'To do',
                                    style: TextStyle(
                            ...
                            DropdownMenuItem(
                              ...
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  StatusContainer(status: TaskStatus.done),
                                  SizedBox(width: 8),
                                  Text(
                                    'Done',
                                    style: TextStyle(
              ...
              SectionTitle(
                ...
                onPressed: () {
                  setState(() {
                    ...
                    createdActionItems.add(
                      ActionItem(id: IdGeneratingService.generate(), title: ""),
                    );
                  });
                },
              ),
              ...
              createdActionItems.isNotEmpty
                  ? Column(
                      children: List.generate(createdActionItems.length, (
                        index,
                      ) {
                        return Container(
                          width: double.infinity,
