...
class RTDBProvider extends DataProvider {
  ...
  Future<void> disconnect() async {
    try {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/disconnect');
    }
  }
  ...
  Future<void> reconnect() async {
    try {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/reconnect');
    }
  }
  ...
  Future<void> set(String path, Object? data) async {
    try {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/set');
    }
  }
  ...
  Future<String?> push(String path, Object? data) async {
    try {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/push');
      return null;
    }
  }
  ...
  Future<Map?> get(String path) async {
    try {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/get');
      return null;
    }
  }
  ...
  Future<Map?> once(String path) async {
    try {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/once');
      return null;
    }
  }
  ...
  Future<void> update(String path, Map<String, dynamic> data) async {
    try {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/update');
    }
  }
  ...
  Future<void> remove(String path) async {
    try {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/remove');
    }
  }
  ...
  Future<void> removeMulti(String parentPath, List<String> paths) async {
    try {
      return await updateMultible(parentPath, {
        for (var path in paths) path: null,
      });
    } catch (e, s) {
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/removeMulti');
    }
  }
  ...
  //SECTION Stream
  //t1 onValue
  Stream<List<Object?>?> onValue(String path, {bool discardKey = false}) {
    try {
      return _rtdb.ref(path).onValue.asyncMap((event) {
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/onValue');
  ...
  Stream<Object?> onChildAdded(String path) {
    try {
      return _rtdb.ref(path).onChildAdded.asyncMap((event) {
        Object? r = event.snapshot.value;
        return r;
      });
    } catch (e, s) {
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/onChildAdded');
      return const Stream.empty();
    }
  }
  ...
  Stream<Object?> onChildChanged(String path) {
    try {
      return _rtdb.ref(path).onChildChanged.asyncMap((event) {
        Object? r = event.snapshot.value;
        return r;
      });
    } catch (e, s) {
  ...
  //t1 OnChildRemoved
  Stream<Object?> onChildRemoved(String path, {bool discardKey = false}) {
    try {
      return _rtdb.ref(path).onChildRemoved.asyncMap((event) {
        Object? r = event.snapshot.value;
        return r;
      });
    } catch (e, s) {
  ...
  Future<TransactionResult?> transact(
    ...
    try {
      return await _rtdb.ref(path).runTransaction((value) {
        //
      ...
      ErrorHandlingService.handle(e, s, location: 'RTDBProvider/transact');
      return null;
    }
  }
